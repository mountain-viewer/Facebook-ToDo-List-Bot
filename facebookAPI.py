...
def send_yelp_results(token, user_id, businesses):
    ...
    for business in businesses:
        ...
        img_url = business['image_url'] if business['image_url'] != "" else url_for('static',
...
def set_menu():
    r = requests.post("https://graph.facebook.com/v2.6/me/thread_settings",
                      params={
                          "access_token": 'EAADhYj0lr14BAGP2HCx2mcYcxQbtQG7iXfaGpOieFsGlgJEYv0Y74bdIYtQ3UcnK1kktfUCDInciDniwTOm1c6l2Fq2GEBsm0Lu4syz5HUc41MGepASZBuXw1caZBkZBGRX5kIZCT7q5QOkiPVnZC3n8iBcqVMCBGnZCiSgscQogZDZD'},
                      data=json.dumps({
